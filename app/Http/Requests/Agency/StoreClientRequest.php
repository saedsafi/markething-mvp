...
class StoreClientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'persona_name' => ['required', 'string', 'max:50'],
            'persona_gender' => ['required', 'string', 'max:255'],
            'persona_age_range' => ['required', 'string', 'max:255'],
            'persona_who' => ['required', 'string', 'max:80'],
            'persona_buyer_is_user' => ['required', 'string', 'max:255'],
            'persona_decider' => ['nullable', 'string', 'max:60'],
            'persona_priorities' => ['required', 'array', 'min:1', 'max:2'],
