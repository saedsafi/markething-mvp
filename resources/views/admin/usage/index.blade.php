...
@section('page-subtitle', 'Monitor AI usage, estimated spend, tokens, failures, and retries.')
...
<div class="admin-page">
    ...
    <div class="stats-grid">
        <x-stats-card label="Estimated Cost" value="${{ number_format($totalCost, 6) }}" hint="Based on token usage" />
        <x-stats-card label="Total Tokens" value="{{ number_format($totalTokens) }}" hint="Input + output tokens" />
    ...
    <div class="admin-main-stack">
            ...
            <table class="dashboard-table">
                ...
                <tbody>
                    @forelse ($costByCallType as $row)
                        <tr>
                            <td>
                                <strong>{{ str_replace('_', ' ', ucfirst($row['call_type'])) }}</strong>
                            </td>
                            ...
                            <td>
                                <strong>${{ number_format($row['cost'], 6) }}</strong>
                            </td>
                        </tr>
                    @empty
                        <tr>
        ...
        <x-data-table title="Cost by Agency">
            <table class="dashboard-table">
                <thead>
                    <tr>
                        <th>Agency</th>
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="5">No agency usage yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <x-data-table title="Top Campaigns by Cost">
            <table class="dashboard-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="6">No campaign usage yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <table class="dashboard-table">
                ...
                <tbody>
                    @forelse ($recentExpensiveCalls as $log)
                        <tr>
                            <td>
                                <strong>{{ str_replace('_', ' ', ucfirst($log->call_type)) }}</strong>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="7">No expensive calls yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
