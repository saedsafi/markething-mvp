...
@section('page-subtitle', 'Review, edit, copy, and regenerate generated campaign posts.')
    ...
    <div class="campaign-output-hero">
        ...
        <div>
            ...
            <p>
                ...
                Review each post, edit content inline, copy posts, or regenerate individual posts once.
            </p>
        </div>
